...
def call_allam_llm(user_message: str) -> str:
    ...
    try:
        ...
        system_prompt = """أنت مساعد خدمة حكومية ذكي متخصص في خدمة تغيير الأسماء (وافي أبشر).
...
def main():
    st.set_page_config(
        page_title="وافي أبشر - تغيير الاسم ",
        page_icon="🇸🇦",
        layout="wide",
    ...
    with col1:
        st.title("🇸🇦 وافي أبشر - خدمة تغيير الاسم")
    with col2:
...
def show_home():
    """الصفحة الرئيسية"""
    st.markdown("""
    ## 👋 أهلاً وسهلاً بك في وافي أبشر
    
    **وافي أبشر** هي خدمة حكومية متكاملة لتغيير الأسماء برقمية عالية الأمان.
